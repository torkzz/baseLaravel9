...
class CreateTblSenderidBlocklistTest05272022V3Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_senderid_blocklist_test_05272022_v3', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_senderid_blocklist_test_05272022_v3');
    }
}
