...
class CreateTblMsisdnTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_msisdn', function (Blueprint $table) {
            ...
            $table->index(['msisdn', 'telco_id'], 'idx_msisdn_telcoid');
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_msisdn');
    }
}
