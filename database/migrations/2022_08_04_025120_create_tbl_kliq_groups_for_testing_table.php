...
class CreateTblKliqGroupsForTestingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_kliq_groups_for_testing', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_kliq_groups_for_testing');
    }
}
