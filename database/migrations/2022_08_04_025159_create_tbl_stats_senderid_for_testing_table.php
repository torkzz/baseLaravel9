...
class CreateTblStatsSenderidForTestingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_stats_senderid_for_testing', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_stats_senderid_for_testing');
    }
}
