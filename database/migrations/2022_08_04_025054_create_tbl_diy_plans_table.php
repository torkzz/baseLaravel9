...
class CreateTblDiyPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_diy_plans', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('consumable_viber')->default(0);
            $table->integer('consumable_viber_mt')->default(0);
            $table->integer('consumable_viber_mo')->default(0);
            $table->decimal('rate_per_viber_mt', 7, 4)->default(0.0000);
            $table->decimal('rate_per_viber_mo', 7, 4)->default(0.0000);
            $table->decimal('rate_per_sms_failover', 7, 4)->default(0.0000);
            $table->integer('viber_threshold')->default(0);
            $table->tinyInteger('status_flag')->nullable()->comment("1-ACTIVE,0-INACTVIE");
            $table->timestamps();
            $table->decimal('rate_per_sms_failover_ng', 7, 4)->default(0.0000);
            $table->decimal('rate_per_sms_failover_dito', 7, 4)->default(0.0000);
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_diy_plans');
    }
}
