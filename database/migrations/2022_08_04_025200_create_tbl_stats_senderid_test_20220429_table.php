...
class CreateTblStatsSenderidTest20220429Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_stats_senderid_test_20220429', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_stats_senderid_test_20220429');
    }
}
