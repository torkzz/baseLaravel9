...
class CreateTblStatsSummaryBackup202201Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_stats_summary_backup_202201', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_stats_summary_backup_202201');
    }
}
