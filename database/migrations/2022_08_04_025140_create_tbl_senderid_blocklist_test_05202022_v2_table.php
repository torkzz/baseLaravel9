...
class CreateTblSenderidBlocklistTest05202022V2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_senderid_blocklist_test_05202022_v2', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_senderid_blocklist_test_05202022_v2');
    }
}
