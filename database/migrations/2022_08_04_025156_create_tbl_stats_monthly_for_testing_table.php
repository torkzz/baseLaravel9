...
class CreateTblStatsMonthlyForTestingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_stats_monthly_for_testing', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_stats_monthly_for_testing');
    }
}
